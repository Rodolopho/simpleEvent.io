export var core={
	...
	animate:function(e,a,b){
		...
		var e=b?document.getElementById(b):this;
		...
		// 	//clearTimeout(i);
		// },1000)
		e.setAttribute('class',e.hasAttribute('class')?e.getAttribute('class')+ " " +a+" animated":" " +a+" animated");
		setTimeout(function(){
			e.setAttribute('class',e.getAttribute('class').replace(a,"").replace('animated',"").trim());
